...
# Default Commands you can try in terminal
    ...
    # To define your script's interpreter as Bash
        ...
        # prefix it with a hashbang  #!                 -  #!/bin/bash

    # To retrieve a current date and time               - date

    # To look up for a calendar                         - cal

    # To check the location of your current
    # working directory                                 - pwd

    # To retrieve a list of all files
    # and directories located within                    - ls
    ...
    # To execute any new file you need to
    # execute the below commands                        -  chmod u+x ./file-name.sh
