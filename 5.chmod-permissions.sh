...
# But often, only three are used. If you use 600 it equals 0600. The missing 
# digit is appended at the beginning of the number.
...
o — others (not the owner or the owners group)
